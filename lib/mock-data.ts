...
export const ventas: Venta[] = [
  { id: "V-4821", fecha: "Hoy 14:20", fechaISO: "2026-09-07", clienteId: "c-1", cliente: "Juan Pérez", vendedorId: "u-2", vendedor: "Caro", procedencia: "Local", items: [{ detalle: "iPhone 13 128GB Azul", cantidad: 1, costoUsd: 560, precioUsd: 735 }], totalUsd: 735, pagos: [{ medio: "transferencia", montoUsd: 735, caja: "usd" }], margenPct: 23.8, tipo: "venta", modalidad: "minorista" },
  { id: "V-4820", fecha: "Hoy 12:05", fechaISO: "2026-09-07", clienteId: "c-2", cliente: "Sofía Ramos", vendedorId: "u-3", vendedor: "Meli", procedencia: "WhatsApp", items: [{ detalle: "Cambio de batería iPhone 12", cantidad: 1, costoUsd: 17, precioUsd: 45 }, { detalle: "Vidrio templado", cantidad: 1, costoUsd: 4, precioUsd: 10 }], totalUsd: 55, pagos: [{ medio: "tarjeta", montoUsd: 55, caja: "usd" }], margenPct: 61.0, tipo: "reparacion", modalidad: "minorista" },
  { id: "V-4819", fecha: "Ayer 18:40", fechaISO: "2026-09-06", clienteId: "c-3", cliente: "Marco Díaz", vendedorId: "u-2", vendedor: "Caro", procedencia: "Instagram", items: [{ detalle: "iPhone 15 Pro 256GB", cantidad: 1, costoUsd: 990, precioUsd: 1240 }], totalUsd: 1240, pagos: [{ medio: "cripto", montoUsd: 1240, caja: "usd" }], margenPct: 20.2, tipo: "venta", modalidad: "minorista" },
  { id: "V-4818", fecha: "Ayer 17:10", fechaISO: "2026-09-06", clienteId: "c-4", cliente: "Lucía Vera", vendedorId: "u-3", vendedor: "Meli", procedencia: "Local", items: [{ detalle: "Vidrio templado", cantidad: 1, costoUsd: 5, precioUsd: 10 }, { detalle: "Funda silicona", cantidad: 1, costoUsd: 5, precioUsd: 12 }], totalUsd: 22, pagos: [{ medio: "pesos", montoUsd: 22, caja: "ars" }], margenPct: 55.0, tipo: "venta", modalidad: "minorista" },
  { id: "V-4817", fecha: "Ayer 11:30", fechaISO: "2026-09-06", clienteId: "c-5", cliente: "Diego Fernández", vendedorId: "u-2", vendedor: "Caro", procedencia: "MercadoLibre", items: [{ detalle: "iPhone 11 64GB", cantidad: 1, costoUsd: 300, precioUsd: 410 }], totalUsd: 410, pagos: [{ medio: "canje", montoUsd: 250, caja: "usd" }, { medio: "pesos", montoUsd: 160, caja: "ars" }], margenPct: 26.8, tipo: "venta", modalidad: "minorista" },
  { id: "V-4816", fecha: "Ayer 10:05", fechaISO: "2026-09-06", clienteId: "c-7", cliente: "Andrés Molina", vendedorId: "u-3", vendedor: "Meli", procedencia: "WhatsApp", items: [{ detalle: "Cambio de pantalla iPhone 13", cantidad: 1, costoUsd: 68, precioUsd: 90 }], totalUsd: 90, pagos: [{ medio: "transferencia", montoUsd: 90, caja: "usd" }], margenPct: 24.4, tipo: "reparacion", modalidad: "minorista" },
  { id: "V-4815", fecha: "Lun 19:20", fechaISO: "2026-09-04", clienteId: "c-8", cliente: "Valentina Cruz", vendedorId: "u-2", vendedor: "Caro", procedencia: "Referido", items: [{ detalle: "iPhone 13 mini 128GB", cantidad: 1, costoUsd: 442, precioUsd: 570 }, { detalle: "AppleCare no oficial 6m", cantidad: 1, costoUsd: 23, precioUsd: 30 }], totalUsd: 600, pagos: [{ medio: "transferencia", montoUsd: 400, caja: "usd" }, { medio: "pesos", montoUsd: 200, caja: "ars" }], margenPct: 22.5, tipo: "venta", modalidad: "minorista" },
  { id: "V-4814", fecha: "Lun 15:40", fechaISO: "2026-09-04", clienteId: "c-1", cliente: "Juan Pérez", vendedorId: "u-3", vendedor: "Meli", procedencia: "Local", items: [{ detalle: "Reparación de placa iPhone XR", cantidad: 1, costoUsd: 96, precioUsd: 160 }], totalUsd: 160, pagos: [{ medio: "pesos", montoUsd: 160, caja: "ars" }], margenPct: 40.0, tipo: "reparacion", modalidad: "minorista" },
  { id: "V-4813", fecha: "Lun 12:10", fechaISO: "2026-09-04", clienteId: "c-6", cliente: "Paula Giménez", vendedorId: "u-2", vendedor: "Caro", procedencia: "WhatsApp", items: [{ detalle: "Cambio de batería iPhone 11", cantidad: 1, costoUsd: 17, precioUsd: 45 }], totalUsd: 45, pagos: [{ medio: "pesos", montoUsd: 45, caja: "ars" }], margenPct: 62.2, tipo: "reparacion", modalidad: "minorista" },
  { id: "V-4812", fecha: "Dom 16:30", fechaISO: "2026-09-03", clienteId: "c-3", cliente: "Marco Díaz", vendedorId: "u-2", vendedor: "Caro", procedencia: "Instagram", items: [{ detalle: "iPhone 14 128GB", cantidad: 1, costoUsd: 680, precioUsd: 860 }], totalUsd: 860, pagos: [{ medio: "cripto", montoUsd: 600, caja: "usd" }, { medio: "transferencia", montoUsd: 260, caja: "usd" }], margenPct: 20.9, tipo: "venta", modalidad: "minorista" },
  { id: "V-4811", fecha: "Dom 13:15", fechaISO: "2026-09-03", clienteId: "c-7", cliente: "Andrés Molina", vendedorId: "u-3", vendedor: "Meli", procedencia: "MercadoLibre", items: [{ detalle: "iPhone SE 2020 64GB", cantidad: 1, costoUsd: 130, precioUsd: 195 }], totalUsd: 195, pagos: [{ medio: "dolares", montoUsd: 195, caja: "usd" }], margenPct: 33.3, tipo: "venta", modalidad: "minorista" },
  { id: "V-4810", fecha: "Sáb 11:50", fechaISO: "2026-09-02", clienteId: "c-2", cliente: "Sofía Ramos", vendedorId: "u-2", vendedor: "Caro", procedencia: "Local", items: [{ detalle: "Cambio de pantalla iPhone XR", cantidad: 1, costoUsd: 54, precioUsd: 75 }], totalUsd: 75, pagos: [{ medio: "transferencia", montoUsd: 75, caja: "usd" }], margenPct: 28.0, tipo: "reparacion", modalidad: "minorista" },
];
